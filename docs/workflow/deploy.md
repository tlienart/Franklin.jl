...
* Now copy the contents of the `__site__` directory to the target location using your chosen method.
 
You should now be able to see the site at `http://my.example.com/path/to/my/franklin/site/index.html`.
