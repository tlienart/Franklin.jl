...
@testset "RSSbasics" begin
    ...
    @test isfile(feed)
    fc = read(feed, String)
    @test occursin("<title><![CDATA[title 2]]></title>", fc)
    @test occursin("<title><![CDATA[title 1]]></title>", fc)
    ...
    @test occursin("<guid>https://github.com/tlienart/Franklin.jl/hey/ho/</guid>", fc)
    @test occursin("<guid>https://github.com/tlienart/Franklin.jl/hey/hello/</guid>", fc)
    @test occursin("<br><a href=\"https://github.com/tlienart/Franklin.jl/hey/ho/\">Read more</a>", fc)
    @test occursin("<br><a href=\"https://github.com/tlienart/Franklin.jl/hey/hello/\">Read more</a>", fc)
    ...
    @test occursin("<title><![CDATA[title 2]]></title>", foo_feed)
    @test occursin("<title><![CDATA[title 1]]></title>", foo_feed)
    ...
    @test occursin("<title><![CDATA[title 2]]></title>", bar_feed)
    @test !occursin("<title><![CDATA[title 1]]></title>", bar_feed)
