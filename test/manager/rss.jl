...
@testset "RSSbasics" begin
    ...
    empty!(F.RSS_DICT)
    F.def_GLOBAL_VARS!()
    F.set_var!(F.GLOBAL_VARS, "site_title", "Website title")
    F.set_var!(F.GLOBAL_VARS, "site_description", "Website description")
    F.set_var!(F.GLOBAL_VARS, "site_url", "https://github.com/tlienart/Franklin.jl/")
    F.def_LOCAL_VARS!()
...
@testset "RSSbasics" begin
    ...
    F.def_GLOBAL_VARS!()
    F.set_var!(F.GLOBAL_VARS, "site_title", "Website title")
    F.set_var!(F.GLOBAL_VARS, "site_description", "Website descr")
    F.set_var!(F.GLOBAL_VARS, "site_url", "https://github.com/tlienart/Franklin.jl/")
    F.def_LOCAL_VARS!()
    set_curpath("hey/ho.md")
    F.set_var!(F.LOCAL_VARS, "rss_title", "title")
