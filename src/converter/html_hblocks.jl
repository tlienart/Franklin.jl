...
"""
function convert_hblock(β::HCond, allvars::PAGE_VARS_TYPE)::String
...
something.
"""
function convert_hblock(β::HCondDef, allvars::PAGE_VARS_TYPE)::String
...
"""
function convert_hblock(β::HCondPage, allvars::PAGE_VARS_TYPE)::String
